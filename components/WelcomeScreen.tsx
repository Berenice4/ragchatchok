                    ...
                    {isAistudioAvailable ? (
                        <>
                            {!isApiKeySelected ? (
                                ...
                                >
                                    Seleziona la Chiave API Gemini per iniziare
                                </button>
                            ) : (
                ...
                <div className="w-full max-w-xl mx-auto">
                    {files.length > 0 && (
                        <button 
                            ...
                            title={!isApiKeySelected ? "Per favore, seleziona o imposta prima una chiave API" : "Avvia la sessione di chat con i file selezionati"}
                        >
                            Carica e Chatta
                        </button>
                    )}
